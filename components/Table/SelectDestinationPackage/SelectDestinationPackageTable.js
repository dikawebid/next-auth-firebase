...
import SelectDestinationPackageTableRow from './SelectDestinationPackageTableRow';
import SimplePaginator from '../../Paginator/SimplePaginator';

const SelectDestinationPackageTable = ({
  destinations,
  total,
  query,
  onSort,
          ...
          <Table size="sm" variant="simple" color="gray.700">
            ...
            <Tbody>
              {destinations.map((item, index) => {
                return (
                  <SelectDestinationPackageTableRow
...
export default SelectDestinationPackageTable;
